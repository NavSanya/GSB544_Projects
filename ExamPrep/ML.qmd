...
Recall: completeness — did we catch all positives?

F1-score: harmonic mean of precision & recall.

ROC-AUC: measures ranking quality; higher = better separation.
...
## Concepts
- LDA: assumes equal covariance for all classes.

- QDA: allows class-specific covariance.
